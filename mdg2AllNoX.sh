...
#	 FILE:	mdg2AllNoX.sh
#
#	USAGE:	mdg2AllNoX.sh n1 n2 n3 n4 n5 n6 n7 n8 n9 n10 n11 n12 n13 n14 n15 n16
#
...
#
# DESCRIPTION:	Used for generating ABC, MIDI, SVG, Postscript, and PDF file 
...
#     CREATED:	2017.08.12 16:20:27 +8
#    REVISION:	2025/05/15 09:50:57
#==================================================================================
...
# ALTERNATIVELY, comment out all three conditionals above then use:
#if [ "${diceS[15]}" == "11" ]; then 
#	dbNum=$(( 11**14 + dbNum ))
#fi
...
# create Postscript; PDF
abcm2ps -q -O=  ./$filen
ps2pdf "K516f-$fileInd.ps"
#
##
###
